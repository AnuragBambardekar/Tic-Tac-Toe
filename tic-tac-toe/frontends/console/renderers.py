...
"""
ConsoleRenderer class overrides .render(), the only abstract 
method responsible for visualizing the game’s current state
"""
...
"""
distinguish the winner's winning marks with blinking text
"""
